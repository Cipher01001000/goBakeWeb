...
{{-- checkout --}}
<div class="content hidden justify-center items-center">
    <div class="flex flex-row justify-center items-center gap-10"
        ...
        <div class="p-5 flex flex-col">
            ...
            <hr>
            <h1 class="p-8 font-sans text-lg leading-snug uppercase font-bold tracking-normal text-blue-gray-900 antialiased">
                Billing details
            </h1>
        ...
        <div class="p-5 flex flex-col">
            ...
            <h1 class="font-sans text-2xl leading-snug uppercase font-bold tracking-normal text-blue-gray-900 antialiased">
                Your Order
            </h1>
            <div class="flex flex-row items-center gap-60 p-3 w-96">
                <h1 class="w-56 font-sans text-lg leading-snug tracking-normal text-blue-gray-900 antialiased">
                    Procuct
                </h1>
                <div class="flex flex-row items-center  p-3">
                    <h1 class="font-sans text-lg leading-snug tracking-normal text-blue-gray-900 antialiased">
                        Subtotal
                    </h1>
                </div>
            </div>
            ...
            {{-- product --}}
            <div class="flex flex-row items-center p-3 gap-12 w-full">
                <div class="flex flex-col">
                    <div class="flex flex-row items-center">
                        <h1 class="font-sans text-sm leading-snug tracking-normal text-blue-gray-900 antialiased">
                            Product:&nbsp;
            ...
            <div class="mt-5 relative h-10 w-72 min-w-[200px]">
                <input
                class="peer h-full w-full rounded-[7px] border border-blue-gray-200 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 focus:border-2 focus:border-pink-500 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50"
                placeholder=" "
                />
            ...
            <button
                class="w-36 mt-5 middle none center rounded-lg bg-pink-500 py-2 px-2 font-sans text-xs font-bold text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                data-ripple-light="true"
                >
                Add Screen Shot
            </button>
            ...
            <a
            class="mt-5 text-center middle none center rounded-lg bg-pink-500 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
            data-ripple-light="true"
            href="{{ url('/qr_code_payment') }}"
            >
            Proceed
            </a>
