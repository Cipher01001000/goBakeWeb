...
<nav class="sticky inset-0 z-10 block h-max w-full max-w-full rounded-none border border-white/80 bg-white bg-opacity-80 py-2 px-4 text-white shadow-md backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
    ...
    <ul class="ml-auto mr-8 flex items-center gap-6 lg:hidden">
      ...
      <ul
        ...
        class="select-none rounded-lg bg-blue-500 p-1 px-2 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
      >
      <div class="flex flex-row justify-center items-center">
        <i class="material-icons text-yellow-700 mr-1">monetization_on</i>
        <div class="text-gray-700">69</div>
      </div>
      </button>
      <div
      ...
      >
        <div class="mb-2 flex items-center gap-3">
          <i class="material-icons text-yellow-700">monetization_on</i>
          <a
            href="#"
        ...
        <p class="block font-sans text-sm font-normal leading-normal text-gray-700 antialiased">
          You can earn Gobake coins in every successfull transactions you make.
        </p>
      ...
      {{-- humburger button pero di ko mapagana --}}
    
      <button
        class="lg:hidden middle none relative ml-auto h-6 max-h-[40px] w-6 max-w-[40px] rounded-lg text-center font-sans text-xs font-medium uppercase text-blue-gray-500 transition-all hover:bg-transparent focus:bg-transparent active:bg-transparent disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none "
