              ...
              <tr class="text-gray-700 border-t border-b">
                <td class="border px-4 py-2">
                    <div class="flex flex-row">
                      <img src="{{ $products->product_image ? asset('storage/' . $products->product_image) : asset('images/no-image.jpg') }}"
                        class="h-20 w-20 rounded-md"
                        alt="product_image">
                        <div class="flex-flex-row">
                          <div class="flex flex-row ml-2">
                            <div class="text-gray-700">Product name:</div>
                            <div class="text-gray-700 ml-2">{{ $products->name }}</div>
                          </div>
                            <div class="flex flex-row ml-2">
                ...
                <td class="border px-4 py-2">
                    <div class="flex flex-row">
                        ...
                        <div class="text-gray-700">{{ $products->price }}</div>
                    </div> 
                </td>
                <td class="border px-4 py-2">
...
<form action="/buyNowPlaceOrder" method="POST">
  @csrf
      ...
      <div class="flex flex-row items-center gap-1 my-2">
        ...
        >
          <div class="flex flex-row items-center gap-1">
            ...
            {{-- <form action="">
              <i class="material-icons text-red-400 ml-1">delete</i>
            </form> --}}
          </div>
        </label>
      </div>
...
<div
  ...
  <form action="/buyNowAddAddress" method="POST">
    @csrf
