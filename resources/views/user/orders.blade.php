<x-layouts.app-layout title="| Orders">
  ...
  <div class="w-full p-5">
    <div class="relative right-0">
      <ul
        class="relative flex list-none flex-wrap rounded-lg bg-light-blue-200 p-1"
        data-tabs="tabs"
        role="list"
      >
        <li class="z-30 flex-auto text-center tab_btn">
          <a
    ...
    {{-- all --}}
    <div class="content flex-col p-5">
      {{-- item1 --}}
      @unless ($orders->isEmpty())
      @foreach ($orders as $index => $order )
      <div class="p-5 m-5 rounded-lg w-full {{ $index % 2 == 0 ? 'bg-gray-300' : 'bg-gray-100' }}">
        <div class="flex flex-row w-full">
            ...
            <div class="flex items-center justify-center">
              ...
              <div class="text-gray-700 text-sm ml-1">{{ $order->status }}</div>
        ...
        <div class="p-5 flex flex-row">
          <img
            ...
            alt="Image placeholder"
            src="{{ $order->product_image ? asset('storage/' . $order->product_image) : asset('images/no-image.jpg') }}"/>
            <div class="flex flex-col p-3 w-full">
              <h1 class="font-sans text-sm leading-snug tracking-normal text-blue-gray-700 antialiased">
                {{ $order->name }}
              </h1>
              <p class="block font-sans text-sm leading-relaxed text-gray-700 antialiased">
                x1
              </p>
              <div class="flex flex-row">
                <p class="block font-sans text-sm leading-relaxed text-gray-700 antialiased mr-1">
                  Ships to:
                </p>
                <p class="block font-sans text-sm leading-relaxed text-gray-700 antialiased">
                  {{ $order->address }}
              ...
              <div class="flex flex-col justify-end items-end w-full">
                ...
                <div class="flex flex-row items-center justify-center p-2">
                  <h1 class="font-sans mr-2 text-sm leading-snug tracking-normal text-blue-gray-900 antialiased">
                    Order Total:
                  </h1>
                  <p class="block font-sans text-sm leading-relaxed text-gray-700 antialiased">
                    {{ $order->price }}
                ...
                {{-- <div class="flex flex-row items-center justify-center gap-3">
                  <a
                    class="middle none center rounded-lg border border-gray-700 py-3 px-6 font-sans text-xs font-bold uppercase text-gray-700 transition-all hover:opacity-75 focus:ring focus:ring-gray-500 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                    data-ripple-dark="true"
                    href="{{ url('/product_review') }}"
                    >
                    Add review
                  </a>
                  <button
      ...
      @endforeach
              ...
              <div class="flex flex-row items-center justify-center p-10">
                  ...
                  <div class="text-gray-700 font-bold text-2xl">You haven't ordered yet!</div>
                </div>
      @endunless
    </div>
  
    {{-- pending --}}
    <div class="content hidden flex-col">
      {{-- item1 --}}
      <div class="p-10 m-5 rounded-lg bg-gray-300 w-full">
    ...
    <div class="content hidden flex-col">
      ...
      <div class="p-10 m-5 rounded-lg bg-gray-300 w-full">
        ...
        <div class="p-5 flex flex-row w-full">
            ...
            class="relative inline-block h-12 w-12 rounded-lg object-cover object-center"
            alt="Image placeholder"
            src="https://plus.unsplash.com/premium_photo-1673296129756-e45408e25250?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=813&q=80"/>
            <h1 class="block m-auto ml-1 font-sans text-sm leading-snug tracking-normal text-blue-gray-900 antialiased">
              Jonathan Joestar
            </h1>
        ...
        <div class="p-5 flex flex-row">
          <img
            class="relative inline-block h-28 w-28 rounded-lg object-cover object-center"
            alt="Image placeholder"
            src="https://images.unsplash.com/photo-1606890737304-57a1ca8a5b62?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzV8fGNha2V8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=600&q=60"/>
            <div class="flex flex-col p-3 w-full">
              <h1 class="font-sans text-sm font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased">
                Black Forest Cake
              </h1>
