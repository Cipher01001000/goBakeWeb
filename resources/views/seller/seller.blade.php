<x-layouts.seller-layout title="| Index">
    <x-partials.seller.sideNav />
                  ...
                  <div class="block opacity-100" id="all" role="tabpanel">
                    <form class="w-full">   
                      ...
                      <div class="relative">
                          ...
                          <input type="search" id="default-search" name="search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-gray-500 focus:border-gray-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gray-500 dark:focus:border-gray-500" placeholder="Search" required>
                ...
                <table class="w-full table-auto">
                  ...
                  <tbody>
                    @foreach ($products as $index => $product)
                      <tr class="{{ $index % 2 == 0 ? 'bg-gray-100' : 'bg-gray-200' }} text-gray-700 border-t border-b">
