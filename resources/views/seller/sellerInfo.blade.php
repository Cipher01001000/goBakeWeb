<x-layouts.seller-layout title="| Seller Info">

    <div class="flex flex-row justify-center gap-10 items-center">

        <div class="p-10 w-1/2 bg-gray-50 shadow-lg">
            <h1 class="text-gray-700 font-2xl">For a seamless and trusted selling experience, please provide your business information to enhance credibility and transparency.</h1>
            <p class="text-gray-500 pt-5">Ensure a seamless and trusted selling experience by sharing your business information. Enhance credibility and transparency, building trust with customers and fostering a strong foundation for successful transactions.</p>
            <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" alt="start_selling"
            class="p-5 rounded-lg w-fit h-fit object-cover">
        </div>

        <div class="p-10 w-1/4 bg-gray-50 shadow-lg">
            <h1 class="text-gray-700 font-bold text-2xl">Business Information</h1>
