...
<main class="bg-gray-100 max-w-lg mx-auto p-5 rounded-lg shadow-2x1 border-2 border-gray-500 m-10">
  ...
  <h2 class="text-gray-800 text-center">Don't have an account?</h2>
  <a
  class="middle none center rounded-lg bg-amber-500 py-3 px-6 font-sans text-xs font-bold text-white shadow-md shadow-amber-500/20 transition-all hover:shadow-lg hover:shadow-amber-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none mt-5 mb-5 text-center"
data-ripple-light="true" href="{{url('register')}}">
  Register Now
  </a>
